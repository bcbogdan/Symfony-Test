 ...
 * @ORM\Entity
 * @UniqueEntity("login", message="Username already in use")
 * @UniqueEntity("password", message="Password already in use")
 */
class Account
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="password", type="string", length=100, nullable=true, unique=true)
     *
     */
    private $password;
