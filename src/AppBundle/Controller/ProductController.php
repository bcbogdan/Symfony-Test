...
class ProductController extends Controller
{
    ...
    public function showAction($id)
    {
        ...
        $historyForm = $this->createAcquisitionHistoryForm($id);
    ...
    */
    ...
    /**
     * Creates a form to display product acquisition history.@global
     *
     * @param mixed $id The entity id
     *
     * @return \Symfony\Component\Form\Form The form
     */
    private function createAcquisitionHistoryForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('productacquisition_show', array('id'=>$id)))
            ->setMethod('GET')
            ->add('submit', 'submit', array('label' => 'History'))
            ->getForm()
        ;
    }
}
